...
class FindProductScreen extends Component {
    ...
    render() {
        const columns = [
            ...
            {
                title: <p style={styles.title}>Phân loại</p>,
                dataIndex: 'phanLoai',
                key: 'phanLoai'

            },
            {
                title: <p style={styles.title}>Giá thành</p>,
                dataIndex: 'gia',
                key: 'gia'
            },
            {
                ...
                render: (text, record) => {
                    return (
                        <div>
                            ...
                            <Button style={{ marginLeft: 20, }} onClick={() => this.props.history.push(`/findproduct/${record.maThuoc}`, { record: record  })}>
                                Chi tiết
                            </Button>
                        </div>
                    )
        ...
        return (
            <div style={styles.container}>
                ...
                <p style={{ fontSize: 24, fontWeight: 'bold', marginTop: 30 }}> Đã tìm được {this.state.count} sản phẩm  </p>

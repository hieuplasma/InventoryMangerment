...
class DetailSelfWorkScreen extends Component {
            ...
            <div style={styles.container}>
                ...
                <div style={styles.box}>
                    ...
                    <div style={styles.item1}>
                        ...
                        <Input style={{ marginLeft: 5 }} size="large" disabled value={data.totalkpi} />
                    </div>
                    <div style={styles.item1}>
                        <p style={styles.feild}>Người giao</p>
                        <Input style={{ marginLeft: 5 }} size="large" disabled value={`${data.nhanVien[0].name}`} />
                ...
                <div style={{ width: '100%', height: 50, display: 'flex', flexDirection: 'row-reverse', marginTop: 30 }}>
                    <Button type="primary" style={{ height: 50, width: 120 }} onClick={() => this.props.history.replace(`/bao-cao/${data.work}`, { id: this.props.location.state.id })}>
                        <span style={{ fontSize: 18 }}>
                            Báo cáo
                        </span>
                    </Button>
                    <Button type="primary" style={{ height: 50, width: 120, marginRight: 20 }} onClick={() => this.props.history.replace(`/phan-cong/${data.work}`, { id: this.props.location.state.id })}>
                        <span style={{ fontSize: 18 }}>
                            Phân công
                        </span>
                    </Button>
...
export default withRouter(DetailSelfWorkScreen);

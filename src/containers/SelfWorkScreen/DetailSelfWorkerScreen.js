...
class DetailSelfWorkerScreen extends Component {
            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => {
                        this.setState({ edit: true }, () => message.success("Đã update thành công"))
                    }
                },
                {
                    label: 'No',
    ...
    render() {
        ...
        const column = [
            ...
            },
            {
                ...
                render: (text, record) => {
                    return (
                        <Input defaultValue={record.soLuongLam} disabled={this.state.edit} type="number" />
                    )
                }
            }
        ]
        ...
        return (
            ...
            <div style={styles.container}>
                ...
                <div style={{ width: '100%', height: 50, display: 'flex', flexDirection: 'row-reverse', marginTop: 30 }}>
                    ...
                    {
                        this.state.edit ?
                            <Button type="primary" style={{ height: 50, width: 200, marginRight: 20 }} onClick={() => this.setState({ edit: false })}>
                                <span style={{ fontSize: 18 }}>
                                    Cập nhật tiến độ
                        </span>
                            </Button>
                            : <Button type="primary" style={{ height: 50, width: 200, marginRight: 20 }} onClick={() => this._submitForm()}>
                                <span style={{ fontSize: 18 }}>
                                    Lưu thay đổi
                </span>
                            </Button>
...
export default withRouter(DetailSelfWorkerScreen);
